...
print("=" * 70)
print("VALIDACION: Terremoto de Arequipa 2018 (Mw 7.1)")
print("Estacion: AREQ")
print("=" * 70)
...
resultados = detector.detect(start_date='2017-08-01', end_date='2018-01-14')
...
# Generar grafico
plot_results(resultados, title='Arequipa 2018 - Evolucion de la pendiente de anomalias')
